...
public class GlobalParameters
{
    ...
    private static Properties _loggerProperties;
    */
    /**
     * A private constructor to prevent an instance of this from being constructed.
     */
     ...
     * 
     * @param params the file object containing the properties
     ...
     * 
     * @param params the desired set of parameter values
     */
...
/*    *//**
     ...
     * called at the beginning of the program to correctly enable the
     * logging of parameter values.
     * 
     * @throws IOException if there are problems with the logging files
     *//*
    public static void setupLogging() throws IOException
    {
        _loggerProperties = new Properties();
        _logFile = new File(_paramsFile.getParent() + File.separatorChar + StringParameter.LOG_FILE.getValue());        
        final FileInputStream loggingPropertiesStream = new FileInputStream(_logFile);
 ...
 /*   *//**
    ...
    {
        return _loggerProperties;
    }*/
    
    /**
     * Return a set of all the parameter names defined in in the
